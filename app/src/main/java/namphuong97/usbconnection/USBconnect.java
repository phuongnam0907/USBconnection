...
public class USBconnect extends Activity {
    ...
    private static final String TAG = USBconnect.class.getSimpleName();
    private static final int USB_VENDOR_ID = 0x1908;
    private static final int USB_PRODUCT_ID = 0x2311;
